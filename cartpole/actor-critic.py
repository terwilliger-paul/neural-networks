...
class MLP(Chain):
    ...
    def __call__(self, x):
        h = self.swish(self.l0(x))
        h = self.swish(self.l1(x))
        h = self.swish(self.l2(h))
        h = self.swish(self.l3(h))
        h = self.swish(self.l4(h))
        h = self.swish(self.l5(h))
        h = self.swish(self.l6(h))
        h = self.swish(self.l7(h))
        h = self.swish(self.l8(h))
        y = self.l9(h)
        return y
